...
if ENV['TM_PROJECT_DIRECTORY'] == '/'
  puts html_head(:window_title => "CUE", :page_title => "CUE List", :sub_title => "Error")
  puts <<-HTML
...
puts html_head(:window_title => "CUE", :page_title => "CUE List", :sub_title => ENV['TM_PROJECT_DIRECTORY'], :html_head => html_head)
