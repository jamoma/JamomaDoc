...
* All Jamoma audio modules has signal output level metering. Metering is done using the "jcom.meter~":components/jcom.meter~.html GUI external rather than the meter~ object, providing more detailed information (in particular at low levels) than meter~ do by default.
