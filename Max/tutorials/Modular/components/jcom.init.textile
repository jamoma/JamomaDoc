...
p. "jcom.init":jcom.init.html is a kind of loadbang that outputs a 'bang' when a module is initialized. It connects to jmod.hub in order to link to all other instances of jmod.init within the same module. It also makes jmod.hub reset all parameters to the default preset.
...
| name | string | Set a name for "jcom.init":jcom.init.html  |
...
* "jmod.initialized":jcom.initialized.html 
* "jcom.hub":jcom.hub.html 
