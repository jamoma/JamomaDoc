...
p. "jcom.oscinstance":oscinstance.html retrieves instance number or ID from incomming OSC messages.
...
# "jcom.oscroute":oscroute.html _Routes Open Sound Control messages_
# "jcom.pass":pass.html _Direct messages and numbers to different outlets_