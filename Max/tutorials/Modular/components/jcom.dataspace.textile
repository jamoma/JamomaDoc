--- 
title: jcom.dataspace
description: jcom.dataspace converts between various types of units using the Jamoma dataspaceLib.
...
p. jcom.dataspace converts between various types of units using the Jamoma dataspaceLib.
...
!../images/jcom.dataspace.refpage.png!


h3(seealso). See also
* "jcom.parameter":jcom.parameter.html
* jcom.message
* jcom.dataspace#
