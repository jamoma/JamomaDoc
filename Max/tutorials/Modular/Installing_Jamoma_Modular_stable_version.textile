...
Installer can be downloaded from the Jamoma web site. Please visit "jamoma.org":http://www.jamoma.org %(seq)1% and follow the "download":http://jamoma.org/download.html link %(seq)2%.

!images/download_installer_1.png!

From the %(samp)download% menu, follow the %(samp)Installer% link %(seq)3%, then download the desired OS version by clicking on the appropriate link %(seq)4%.
...
Max is now properly set up for Jamoma. Have fun exploring the various provided "modules":Index_of_modules.html and examples !
