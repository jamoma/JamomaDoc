...
h3(StepTitle). %(StepNumber)1% Downloading Jamoma installer
...
h3(StepTitle). %(StepNumber)2% Running the installer package
...
h3(StepTitle). %(StepNumber)3% Setting up Max 5 preferences
