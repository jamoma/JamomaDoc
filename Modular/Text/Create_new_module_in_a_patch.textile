...
h3(StepTitle). <span class="StepNumber">1</span>Using Jamoma modules as abstractions
...
h3(StepTitle). <span class="StepNumber">2</span>Using module as bpatcher
...
h3(StepTitle). <span class="StepNumber">3</span>Using jcom.layout
...
h3(StepTitle). <span class="StepNumber">4</span>Summary
