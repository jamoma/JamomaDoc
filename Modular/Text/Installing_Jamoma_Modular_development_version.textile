...
h2(LessonTitle). Installing Jamoma Modular development version
...
h3(StepTitle). <span class="StepNumber">1</span>Getting Git under OSX
...
h3(StepTitle). <span class="StepNumber">2</span>Getting Git under Windows

Not yet available. Please ask for help on Jamoma forum.

h3(StepTitle). <span class="StepNumber">3</span>Cloning Jamoma repository
...
code. git clone http://github.com/jamoma/Jamoma.git
...
h3(StepTitle). <span class="StepNumber">4</span>Building Jamoma framework and externals

Another Ruby script is provided to automate the building of all framework and Max externals. Assuming your are still running your Terminal session from the _Tools_ folder, execute the provided script by typing @ruby build.rb Development clean@ and hitting %(kbd)&#x21A9;%. The script will compile every component needed and copy them to their appropriate place.
...
h3(StepTitle). <span class="StepNumber">5</span>Setting Max preferences
...
!images/media_1283896186931.png!
