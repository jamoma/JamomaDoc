...
h3(StepTitle). %(StepNumber)1% Getting Git under OSX
...
h3(StepTitle). %(StepNumber)2% Getting Git under Windows

Not yet available. Please ask for help on Jamoma forum.

h3(StepTitle). %(StepNumber)3% Cloning Jamoma repository
...
h3(StepTitle). %(StepNumber)4% Building Jamoma framework and externals
...
h3(StepTitle). %(StepNumber)5% Setting Max preferences
